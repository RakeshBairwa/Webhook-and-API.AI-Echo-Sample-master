...
restService.post("/audio", function(req, res) {
  ...
  switch (req.body.result.parameters.AudioSample.toLowerCase()) {
    ...
    case "music one":
      speech =
        '<speak><audio src="https://drive.google.com/file/d/1Q88FA5ciUy79wCAM7f8KxZ4JpOh5bfEH/view">did not get your audio file</audio></speak>';
      break;
    case "music two":
      speech =
        '<speak><audio clipBegin="1s" clipEnd="3s" src="https://drive.google.com/file/d/1Q88FA5ciUy79wCAM7f8KxZ4JpOh5bfEH/">did not get your audio file</audio></speak>';
      break;
    case "music three":
      speech =
